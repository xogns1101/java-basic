...
public class HashSetExample {
    ...
    public static void main(String[] args) {
        ...
        /*
         - set 은 인덱스가 없기 떄문에 메서드를 이용해서 객체를 얻는게 아니라
        ...
        */
        ...
        /*
         # 객체에서 equals 메서드를 오버라이딩 할 때 hashCode 도 같이 오버라이딩 해야 하는 이유
         - Hash 알고리즘을 사용하는 다른 객체가 본래의 속성을 띄게 하려면
          객체의 필드값이 같았을 때 같은 hashCode 의 값을 띄게 해 줘야 한다.
          (HashSet -> HashCode 를 통해 중복 여부를 확인하기 때문.)
         */
