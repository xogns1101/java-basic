...
public class InputStreamEx {
    ...
    public static <fis> void main(String[] args) {
        ...
        /*
             ...
             3. InputStream 객체는 생성자에 throws 가 있기 때문에
              예외처리를 진행하셔야 합니다.
         */


        // try-with-resurces 문법을 사용하여 auto close 를 진행할 수 있다. (자바 8 버전)
        // close 하려는 객체가 AutoCloseable 인터페이스와 구현 관계여야 합니다.
        try(FileInputStream fis= new FileInputStream("C:\\Myworkspace");) {
            int data = 0;
