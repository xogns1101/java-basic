...
public class BufferedOutEx {
    ...
    public static void main(String[] args) {
        ...
        // ex) BufferedOutputStream -> FileOutputStream 을 매개 값으로 받아야 한다.
        ...
        try(FileOutputStream fos = new FileOutputStream("C:\\Myworkspace\\bout.txt");
            ...
            // 새로운 String 객체 생성 -> 생성자의 매개값으로 StringBuilder 를 전달.
            // 바이트 데이터로 변환.
            String str = new String(text); // StringBuilder 를 String 으로 변환
