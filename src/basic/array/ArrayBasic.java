...
//        arr[5] = 200; (x) index 범위를 초과
        ...
        System.out.println("배열의 1번쨰 데이터: " + arr[0]);
        System.out.println("배열의 2번쨰 데이터: " + arr[1]);
        System.out.println("배열의 3번쨰 데이터: " + arr[2]);
        System.out.println("배열의 4번쨰 데이터: " + arr[3]);
        System.out.println("배열의 5번쨰 데이터: " + arr[4]);
